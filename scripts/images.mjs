...
const PLACEHOLDERS = {
  ...
  'patu-01': ['#a6b094', '#3e4a36', 0.66],
  'patu-02': ['#c2b9a1', '#5f5843', 0.75],
  'patu-03': ['#93a08c', '#38433a', 1.25],
  'patu-04': ['#b0ab93', '#4c4a3a', 1.25],
  'patu-05': ['#9ea88f', '#414b3a', 0.66],
  'patu-06': ['#c7c0ab', '#66604c', 0.75],
  ...
  'masseria-01': ['#c0b79e', '#5c5744', 0.66],
  'masseria-02': ['#98a38e', '#3b453a', 0.75],
  'masseria-03': ['#b9b19a', '#524f3f', 1.25],
  'masseria-04': ['#a5ad96', '#454b3c', 1.25],
  'masseria-05': ['#c6bda6', '#65604a', 0.66],
  'bio-01': ['#a8ae98', '#464b3c', 1.25],
};
